...
export function HeroSection() {
  ...
  return (
    <section className={styles.hero}>
      ...
      {/* ── Visual area (clipped at bottom — phone half-visible) ── */}
      <div className={styles.heroVisual}>
        ...
        {/* Phone — behind landscape, center aligned to heroVisual bottom */}
        <motion.div
      ...
      {/* ── Landscape — full natural height, bleeds into next section ── */}
